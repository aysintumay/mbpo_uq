...
from train_world_transition import train
from common.buffer import ReplayBuffer
from common.logger import Logger
from trainer import Trainer
from common.util import set_device_and_logger,set_global_device
...
def evaluate_mbpo(policy, seed, trainer, args):
...
def get_args():
    ...
    parser.add_argument("--transition_model_path" , type=str, default="saved_models/hopper-expert-v0_noisy/transition_world_model_0.01_0.0.pth")
    ...
    parser.add_argument("--task", type=str, default="hopper-expert-v0")
...
def main(args):
    ...
    for seed in args.seeds:
        ...
        if args.task == 'Abiomed-v0':
            scaler_info, policy, trainer = train(run, seed, args)
            args.data_name = 'test'
            args.pretrained = True
            eval_info = test(trainer, policy, run, scaler_info, seed, args)
            ...
            policy, trainer = train(run, seed, args)

            # with open('/home/ubuntu/mbpo_uq/saved_models/policy_hopper-expert-v0_0.pth', 'rb') as f:
